...
declare global {
	namespace App {
		// interface Error {}
		interface Locals {
			supabase: import('@supabase/supabase-js').SupabaseClient<import('$lib/types/database.types').Database>
...
declare module '$app/navigation' {
	...
	export function onNavigate(fn: (navigation: { from: URL | null; to: URL | null; type: 'enter' | 'leave' | 'link' | 'goto' | 'popstate'; complete: Promise<void> }) => void | Promise<void>): void;
	...
	export const navigating: import('svelte/store').Readable<{ from: URL | null; to: URL | null; type: 'enter' | 'leave' | 'link' | 'goto' | 'popstate' } | null>;
	export const page: import('svelte/store').Readable<{ url: URL; params: Record<string, string>; route: { id: string | null }; status: number; error: Error | null; data: Record<string, any>; form?: any; state: Record<string, any> }>;
